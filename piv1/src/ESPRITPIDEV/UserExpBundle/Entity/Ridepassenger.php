...
class Ridepassenger
{
     ...
     * Set idpassenger
     *
     * @param \ESPRITPIDEV\UserExpBundle\Entity\User $idpassenger
     *
     * @return Ridepassenger
     */
    public function setIdpassenger(\ESPRITPIDEV\UserExpBundle\Entity\User $idpassenger = null)
    {
     ...
     * @return Ridepassenger
     */
    public function setIdfiliale(\ESPRITPIDEV\UserExpBundle\Entity\Filiale $idfiliale = null)
    {
