...
class Rideanimal
{
     ...
     * @ORM\OneToOne(targetEntity="ESPRITPIDEV\UserExpBundle\Entity\Ridepassenger")
     * @ORM\JoinColumns({
     ...
     * Set id
     *
     * @param \ESPRITPIDEV\UserExpBundle\Entity\Ridepassenger $id
     *
     * @return Rideanimal
     */
    public function setId(\ESPRITPIDEV\UserExpBundle\Entity\Ridepassenger $id)
    {
        $this->id = $id;
